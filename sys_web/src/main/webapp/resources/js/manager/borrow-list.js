$(function () {
    ...
    function to_page(pageNo) {
        ...
        if (urlParam !== null){
            ...
            url = "/admin/booksBRecord?pageNo=" + pageNo + "&keyword=" + keyword
        }
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                $.each(pageInfo.list, function (index, item) {
                    ...
                    var borrow_days = parseInt((new_time - borrow_time) / (1000 * 60 * 60 * 24));
                    ...
                    $("#borrow-list").append("<tr class=\"gradeX\">\n" +
                        "                                        <td class=\"am-text-middle\">" + item.borrowId + "</td>\n" +
                        ...
                        "                                        <td class=\"am-text-middle\">" + borrowStatus + "</td>\n" +
                        "                                    </tr>");
                });
